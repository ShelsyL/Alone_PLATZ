        ...
        <div class="work">
          ...
          <div class="wrapper-text-description">
            ...
            <div class="wrapper-file">
              <div class="icon-file">
                <img :src="'assets/img/' + post.categorie.picto" alt="" width="21" height="21"/>
              </div>
            ...
            <div class="wrapper-weight">
              ...
              <div class="text-weight">{{ post.size }}</div>
            </div>
...
/* NOTES ../../../../public/assets/img/ |OU|  ~/assets/img/ */
...
#stripes {
	background: url("~/assets/img/stripes.svg") no-repeat;
	position: absolute;
	width: 27px;
	height: 20px;
	right: 15px;
...
#fleche-nav-3 {
	float: left;
	margin-top: 26px;
	background: url("~/assets/img/fleche-nav.svg") no-repeat;
	width: 5px;
	height: 10px;
	margin-left: 5px;
}
...
#cross-menu {
	...
	right: 25px;
	margin-top: 25px;
	background: url("~/assets/img/cross-menu.svg") no-repeat;
	cursor: pointer;
}
...
.small-logo {
	...
	left: 50%;
	margin-left: -65.5px;
	background: url("~/assets/img/small-logo.svg") no-repeat;
}
...
.image-reply-post-2 {
	background: url("~/assets/img/avatar-2.png") no-repeat;
}
...
#tip_newsletter_input {
	...
	box-shadow: none;
	outline: 0;
	background: url("~/assets/img/icon-newsletter.svg") no-repeat 10px 9px;
	margin-left: 20px;
...
#tip_search_input {
	...
	outline: 0;
	margin: 0;
	background: url("~/assets/img/icon-search.svg") no-repeat 12px 7px;
	vertical-align: center;
	margin-left: -40px;
	background-color: #FFF;
}
